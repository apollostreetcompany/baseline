...
func renderBootstrapContract(cfg Config) string {
	...
	b.WriteString("- `baseline run`: normal real eval of the default target.\n")
	...
	b.WriteString("- Timeout: store the partial responses and timing; do not rerun the same failing command more than twice.\n")
