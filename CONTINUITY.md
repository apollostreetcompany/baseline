...
### Now
- Bead 34 current merged main is deployed from clean worktree `/Users/kikimac/.hermes/repos/apollostreetcompany/baseline-bead34-main` at source commit `cda91d1b3d3a8244cd8a11424ea39f963d8dc14b`. Worker version `d313f92f-bb02-47b0-81ec-8d571dc61ed7` is live on `https://trackbaseline.com`, `https://www.trackbaseline.com`, and the workers.dev fallback; rollback target is previous Fable copy polish version `4966bc91-0e4a-4657-8589-96a14e78d2c1`.
- Cloudflare operations now use `cf` from `/Users/kikimac/.hermes/node/bin/cf`. `cf workers deployments list --script-name baseline-ai` confirms active deployment `36ecaeb4-2ef8-48dc-8f01-678378ca7c08` serves Worker version `d313f92f-bb02-47b0-81ec-8d571dc61ed7` at 100% traffic.
