...
### Now
- Bead 37 PR #12 is open from `codex/feat/bead-37-checkout-router`; implementation commit `48057c27d64edba262dbfa46d747ef7334183793` is already deployed to production Worker version `0ddb077d-5188-4256-98eb-baf449a30d4c`. Receipt docs and bead evidence are being committed before merge.
- Current production is deployed from `codex/feat/bead-37-checkout-router` implementation commit `48057c27d64edba262dbfa46d747ef7334183793`. Worker version `0ddb077d-5188-4256-98eb-baf449a30d4c` is live on `https://trackbaseline.com`, `https://www.trackbaseline.com`, and the workers.dev fallback through `cf` deployment `914c9007-c221-4ebd-bb6a-7b8ed1b452b7` (`source: api`, 100% traffic); rollback target is previous secret-triggered production version `c4ec271a-5520-4cfe-afe7-15de1b905fb3` or prior code version `d313f92f-bb02-47b0-81ec-8d571dc61ed7`.
