...
### Now
- Bead 37 checkout router is implemented from clean worktree `/Users/kikimac/.hermes/repos/apollostreetcompany/baseline-bead-35-checkout-router` on branch `codex/feat/bead-37-checkout-router`. Claude Fable 5 `subreview` reviewed the implemented diff at `/tmp/baseline-subreview-checkout-implementation/claude.md`; acted-on findings include hiding the public founder code, verifying Stripe coupon limits/duration, founder entitlement source tagging, webhook retry reprocessing, canonical Datafa.st coupon telemetry, and `coupon_present` session status. Production deploy/readback remains pending.
- Current merged main is deployed from clean worktree `/Users/kikimac/.hermes/repos/apollostreetcompany/baseline-prod-cf-deploy` at source commit `cb54ea1a7c04194ab41f2744765a97fbd4b1ac67`. Worker version `d313f92f-bb02-47b0-81ec-8d571dc61ed7` is live on `https://trackbaseline.com`, `https://www.trackbaseline.com`, and the workers.dev fallback through `cf` deployment `56391404-4f21-4b3f-b2fb-04a74aa29696` (`source: api`, 100% traffic); rollback target is previous Fable copy polish version `4966bc91-0e4a-4657-8589-96a14e78d2c1`.
- Cloudflare operations now use `cf` from `/Users/kikimac/.hermes/node/bin/cf`. `cf workers deployments list --script-name baseline-ai` confirms active deployment `56391404-4f21-4b3f-b2fb-04a74aa29696` serves Worker version `d313f92f-bb02-47b0-81ec-8d571dc61ed7` at 100% traffic.
